...
class MLflowStartupError(PointlessSQLError, RuntimeError):
    ...
    Attributes:
        ...
        error_code: Always ``ErrorCode.MLFLOW_STARTUP_ERROR``.
    """

    status_code: int = 503
    error_code: ErrorCode = ErrorCode.MLFLOW_STARTUP_ERROR
