...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("optimize", sa.Boolean(), server_default=sa.true(), nullable=False),
        sa.Column("vacuum", sa.Boolean(), server_default=sa.true(), nullable=False),
        sa.Column("analyze", sa.Boolean(), server_default=sa.true(), nullable=False),
