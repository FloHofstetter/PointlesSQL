"""phase 139: per-output-port identity constraints (E10)
...
Revision ID: x5j7l9n1p3r5
Revises: v3h5j7l9n1p3
...
revision: str = "x5j7l9n1p3r5"
down_revision: str | None = "v3h5j7l9n1p3"
