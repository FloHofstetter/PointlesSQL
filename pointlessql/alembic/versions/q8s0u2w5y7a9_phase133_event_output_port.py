"""phase 133: event-stream output-port substrate (B1/D1)
...
Revision ID: q8s0u2w5y7a9
Revises: o6q8s0u2w5y7
...
revision: str = "q8s0u2w5y7a9"
down_revision: str | None = "o6q8s0u2w5y7"
