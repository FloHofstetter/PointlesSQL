"""workspace foundation: workspaces + members + pins + bootstrap seed (Phase 28.0)
...
Revision ID: z6w8a0b2c4d6
Revises: y5u7v9w1x3z5
...
revision: str = "z6w8a0b2c4d6"
down_revision: str | None = "y5u7v9w1x3z5"
