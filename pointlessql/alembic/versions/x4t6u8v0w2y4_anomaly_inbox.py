"""anomaly inbox + per-run severity cache (Phase 18.6)
...
Revision ID: x4t6u8v0w2y4
Revises: w3s5t7u9v1x3
...
revision: str = "x4t6u8v0w2y4"
down_revision: str | None = "w3s5t7u9v1x3"
