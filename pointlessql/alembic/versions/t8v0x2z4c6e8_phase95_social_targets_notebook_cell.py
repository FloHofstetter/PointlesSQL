"""phase95 — add 'notebook_cell' to social_targets.entity_kind CHECK
...
Revision ID: t8v0x2z4c6e8
Revises: s7u9w1y3b5d7
...
revision: str = "t8v0x2z4c6e8"
down_revision: str | None = "s7u9w1y3b5d7"
