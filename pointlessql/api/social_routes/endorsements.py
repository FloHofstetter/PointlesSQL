...
async def list_social_endorsements(
    ...
    return await list_polymorphic_endorsements(
...
async def apply_social_endorsement(
    ...
    polymorphic_ref = parse_ref(kind, ref)
    return await apply_polymorphic_endorsement(
        kind, polymorphic_ref, request
    )
...
async def remove_social_endorsement(
    ...
    polymorphic_ref = parse_ref(kind, ref)
    return await remove_polymorphic_endorsement(
        kind, polymorphic_ref, endorsement_id, request
    )
