"""Home surface + global search — package facade.

* :mod:`.index` — ``GET /`` renders the home activity feed.
...
from pointlessql.api.home_routes.index import router as _index_router
