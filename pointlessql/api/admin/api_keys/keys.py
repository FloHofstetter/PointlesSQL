"""Admin CRUD + lifecycle for the api_keys table (create/revoke/rotate/quarantine/ttl)."""
...
from pointlessql.api.admin.api_keys._shared import serialize
...
async def api_admin_list_api_keys(
    ...
    return {"keys": [serialize(row) for row in rows]}
