...
import { dataframeStudio } from './pages/dataframe_studio.js';
...
import { jobDagEditor } from './pages/job_dag_editor.js';
...
import { requestAccess, tableCertification } from './pages/table_governance.js';
...
window.dataProductCanvasTab = dataProductCanvasTab;
...
window.tableCertification = tableCertification;
...
window.jobDagEditor = jobDagEditor;
window.dataframeStudio = dataframeStudio;
