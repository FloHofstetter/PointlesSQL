...
export const BLOCK_DEFS = {
  ...
  SemiJoin: {
    ...
    help: 'Keep left rows that have a match in right (EXISTS).',
    inputs: 2,
    outputs: 1,
    inPins: ['left', 'right'],
    outPins: ['out'],
  ...
  AntiJoin: {
    ...
    help: 'Keep left rows with no match in right (NOT EXISTS).',
    inputs: 2,
    outputs: 1,
    inPins: ['left', 'right'],
    outPins: ['out'],
  ...
  Unnest: {
    ...
    help: 'Expand a LIST column into one row per element.',
    inputs: 1,
    outputs: 1,
    inPins: ['in'],
    outPins: ['out'],
    group: 'transforms',
    defaultConfig: () => ({ column: '', with_ordinality: false, ordinality_alias: 'ordinality' }),
  },
  Union: {
    type: 'Union',
    label: 'Union',
  ...
  Except: {
    ...
    label: 'Except',
    icon: 'bi-dash-square',
    help: 'Set difference: rows in left that are not in right.',
    inputs: 2,
    outputs: 1,
    inPins: ['left', 'right'],
    outPins: ['out'],
  ...
  Intersect: {
    ...
    label: 'Intersect',
    icon: 'bi-intersect',
    help: 'Set intersection: rows present in both left and right.',
    inputs: 2,
    outputs: 1,
    inPins: ['left', 'right'],
    outPins: ['out'],
